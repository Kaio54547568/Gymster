      ...
      {showPaymentModal && selectedPackage && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-8" onClick={() => setShowPaymentModal(false)}>
          <div className="bg-[#0c1014] border border-[#EF233C]/30 rounded-3xl p-8 max-w-2xl w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mb-6">
              <h4 className="text-white font-bold mb-4">Chọn phương thức thanh toán</h4>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { id: 'cash', name: 'Tiền mặt', icon: Wallet },
                  { id: 'bank', name: 'Chuyển khoản', icon: Building },
                  { id: 'card', name: 'Thẻ tín dụng', icon: CreditCard },
                  { id: 'wallet', name: 'Ví điện tử', icon: Smartphone }
